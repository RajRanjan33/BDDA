# -*- coding: utf-8 -*-
"""
Created on Sat Aug  6 23:25:21 2022
...
df = pd.read_csv("C:/Users/Raj-Lenovo/Desktop/FORE/TERM-4/BDDA/Python Dashboard_Zomato/dataset/zomato.csv",encoding="ISO-8859-1")
df.head()
...
new = pd.DataFrame({col_label:v.index,col_values:v.values})
...
#most popular restaurants in India
...
app.layout = html.Div([html.Br(),graphRow1,html.Br(),graphRow2], style={'backgroundColor':'black'})
